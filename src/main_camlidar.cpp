...
#include "bluefox_multiple_ros_camlidar.h"
...
int main(int argc, char **argv) {
    ...
    BlueFOX_MULTIPLE_ROS_CAMLIDAR *bluefoxs = 
        new BlueFOX_MULTIPLE_ROS_CAMLIDAR(nh, binning_on, software_binning_on, software_binning_level, triggered_on, 
